...
struct ChessBoard
{
    ...
    void printHelp(){
        cout<<endl<<"*Press:-\nh: help\nq: quit\np: show board\nc: toggle show coordinates inside squares"<<endl<<"*Input format: yxyx is from-to coordinates, e.g: 1715 moves (x,y)=(1,7) to (x,y)=(1,5)"<<endl<<endl;
    }
